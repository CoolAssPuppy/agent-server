...
export class ConversationStore {
    ...
    maxConversations;
    constructor(maxConversations = DEFAULT_MAX_CONVERSATIONS) {
        this.maxConversations = maxConversations;
    }
    create(chatId, agentId, ttlMs) {
        const now = new Date();
        const conversation = {
            id: randomUUID(),
            chatId,
